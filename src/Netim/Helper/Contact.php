        ...
        if (isset($this->getStateCodeToStateMappings()[$this->country]) && isset($this->getStateCodeToStateMappings()[$this->country][$this->area])) {
            if (is_array($this->getStateCodeToStateMappings()[$this->country][$this->area])) {
                if (isset($this->getStateCodeToStateMappings()[$this->country][$this->area][$lang])) {
                    ...
                    $this->area = $this->getStateCodeToStateMappings()[$this->country][$this->area]["en"];
                }
            } else {
                $this->area = $this->getStateCodeToStateMappings()[$this->country][$this->area];
            }
        }

        if (isset($this->getCountryCodeToCountryMappings()[$this->country])) {
            if (isset($this->getCountryCodeToCountryMappings()[$this->country][$lang])) {
                $this->country = $this->getCountryCodeToCountryMappings()[$this->country][$lang];
            } else {
                $this->country = $this->getCountryCodeToCountryMappings()[$this->country]["en"];
            }
        }
